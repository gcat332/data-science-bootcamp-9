...
chatbot <- function() {
  ...
  order_list[nrow(order_list)+1,] <- list(menu$menu[as.numeric(order_menu)],pizza_favour$favour[as.numeric(order_favour)],menu$price[as.numeric(order_menu)] + pizza_favour$extra_price[as.numeric(order_favour)])
